...
<html lang="en">
	...
	<body>
		...
		<script type="text/javascript" src="{{asset('menu_editor/jquery-menu-editor.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('menu_editor/bootstrap-iconpicker/js/iconset/fontawesome5-3-1.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('menu_editor/bootstrap-iconpicker/js/bootstrap-iconpicker.min.js')}}"></script>
		<script>
