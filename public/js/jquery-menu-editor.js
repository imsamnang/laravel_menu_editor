...
function MenuEditor(idSelector, options) {
    ...
    var settings = {
        ...
        labelRemove: '<i class="fa fa-remove clickable"></i>',
    ...
    function TButtonGroup() {
        ...
        var $btnEdit = TButton({classCss: 'btn btn-primary btn-xs btnEdit', text: '<i class="fa fa-edit clickable"></i>'});
        var $btnRemv = TButton({classCss: 'btn btn-danger btn-xs btnRemove', text:'<i class="fa fa-trash clickable"></i>'});
        var $btnUp = TButton({classCss: 'btn btn-success btn-xs btnUp btnMove', text: '<i class="fa fa-chevron-up clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-primary btn-xs btnDown btnMove', text: '<i class="fa fa-chevron-down clickable"></i>'});
        var $btnOut = TButton({classCss: 'btn btn-secondary btn-xs btnOut btnMove', text: '<i class="fa fa-download clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-dark btn-xs btnIn btnMove', text: '<i class="fa fa-external-link clickable"></i>'});
